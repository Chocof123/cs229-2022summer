...
def update_W(W, x, learning_rate):
    """
    Perform a gradient ascent update on W using data element x and the provided 
    learning rate.
...
def unmixer(X):
    ...
    anneal = [0.1 , 0.1, 0.1, 0.05, 0.05, 0.05, 0.02, 0.02, 0.01 , 0.01, 0.005, 
