...
def softmax(x):
    ...
    # *** START CODE HERE ***
    x_expect = np.exp(x)
    sum_x_exp = np.sum(x_expect, axis=1, keepdims=True)
    return x_expect / sum_x_exp
    # *** END CODE HERE ***
...
def forward_prop(data, labels, params):
    ...
    loss_avg = loss / len(data)
    return A1, preds, loss_avg
    # *** END CODE HERE ***
...
def gradient_descent_epoch(train_data, train_labels, learning_rate, batch_size, params, forward_prop_func, backward_prop_func):
    ...
    for batch_data, batch_labels in batches:
        ...
        for wt in ['W1', 'b1', 'W2', 'b2']:
            params[wt] -= learning_rate * grads[wt] # update params
    # *** END CODE HERE ***
